...
///
public func => <A: MyDecodable>(json: Any, keyPath: KeyPath) throws -> [[A]?]? {
...
/// - returns: `nil` if the object at `path` is `NSNull`
///
public func => <A: MyDecodable, B: MyDecodable>(json: Any, keyPath: KeyPath) throws -> [[A: B]?]? {
...
/// - returns: `nil` if the object at `path` is `NSNull`
///
public func => <A: MyDecodable, B: MyDecodable, C: MyDecodable>(json: Any, keyPath: KeyPath) throws -> [[A: [B: C]]]? {
...
/// - returns: `nil` if the object at `path` is `NSNull`
///
public func => <A: MyDecodable, B: MyDecodable, C: MyDecodable, D: MyDecodable>(json: Any, keyPath: KeyPath) throws -> [A: [B: [C: D]]]? {
...
/// - returns: something
///
public func => <A: MyDecodable, B: MyDecodable, C: MyDecodable, D: MyDecodable, E: MyDecodable>(json: Any, keyPath: KeyPath) throws -> [A: [B: [C: [D: E]]]] {
...
///
public func =>? <A: MyDecodable>(json: Any, keyPath: OptionalKeyPath) throws -> [[A?]?]? {
...
/// - returns: `nil` if the object at `path` is `NSNull` or if any optional key is missing.
///
public func =>? <A: MyDecodable, B: MyDecodable>(json: Any, keyPath: OptionalKeyPath) throws -> [[[A: B]]?]? {
...
/// - returns: `nil` if the object at `path` is `NSNull` or if any optional key is missing.
///
public func =>? <A: MyDecodable, B: MyDecodable, C: MyDecodable>(json: Any, keyPath: OptionalKeyPath) throws -> [[A: [B: C]]?]? {
...
/// - returns: `nil` if the object at `path` is `NSNull` or if any optional key is missing.
///
public func =>? <A: MyDecodable, B: MyDecodable, C: MyDecodable, D: MyDecodable>(json: Any, keyPath: OptionalKeyPath) throws -> [[A: [B: [C: D]]]]? {
...
/// - returns: `nil` if the object at `path` is `NSNull` or if any optional key is missing.
///
public func =>? <A: MyDecodable, B: MyDecodable, C: MyDecodable, D: MyDecodable, E: MyDecodable>(json: Any, keyPath: OptionalKeyPath) throws -> [A: [B: [C: [D: E]]]]? {
