...
extension MyDecodable where Self: DynamicDecodable, Self.DecodedType == Self {
...
extension String: MyDecodable, DynamicDecodable {
    public static var decoder: (Any) throws -> String = { try cast($0) }
}
extension Int: MyDecodable, DynamicDecodable {
    public static var decoder: (Any) throws -> Int = { try cast($0) }
}
extension Double: MyDecodable, DynamicDecodable {
    public static var decoder: (Any) throws -> Double = { try cast($0) }
}
extension Bool: MyDecodable, DynamicDecodable {
...
extension Date: MyDecodable, DynamicDecodable {
...
extension NSDictionary: MyDecodable {
    public static func decode(_ json: Any) throws -> Self {
...
extension URL: DynamicDecodable, MyDecodable {
