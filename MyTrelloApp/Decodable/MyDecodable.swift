...
extension Dictionary where Key: MyDecodable, Value: MyDecodable {
...
extension Array where Element: MyDecodable {
...
public func decodeAsOneOf(_ json: Any, objectTypes: MyDecodable.Type...) throws -> MyDecodable {
...
/// Attempt to decode one of multiple objects in order until: A: we get a positive match, B: we throw an exception if the last object does not decode
public func decodeArrayAsOneOf(_ json: Any, objectTypes: MyDecodable.Type...) throws -> [MyDecodable] {
